...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const cardStyle = useMemo(
        () => ({
            ...
            '--inner-gradient': innerGradient ?? 'linear-gradient(145deg,#60496e8c 0%,#71C4FF44 100%)',
            ...
            <div ref={shellRef} className="relative z-[1] group h-full w-full">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                className="w-full h-full object-cover absolute left-0 top-0 will-change-transform transition-transform duration-[120ms] ease-out"
                                src={avatarUrl}
                                alt={`${name || 'User'} avatar`}
                                loading="lazy"
                                style={{
                                    transformOrigin: 'center center',
                                    transform: 'scale(calc(1 + (var(--pointer-from-center) * 0.05)))',
                                    borderRadius: cardRadius,
                                    backfaceVisibility: 'hidden',
                                ...
                                onError={e => {
                                    ...
                                    // Fallback to a generic artistic gradient/placeholder if the main image fails
                                    t.src = 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=500&auto=format&fit=crop&q=60';
                                }}
                            />
                            <div
                                className="absolute inset-0 pointer-events-none"
                                style={{
                                    background: 'linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.2) 60%, rgba(0,0,0,0.7) 100%)',
                                    borderRadius: cardRadius,
                                }}
                            />
                            {showUserInfo && (
                            ...
                            <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                                <h3
                                    ...
                                    style={{
                                        ...
                                        backgroundImage: 'linear-gradient(to bottom, #ffffff 40%, #a5a5d9 100%)',
                                ...
                                <p
                                    ...
                                    style={{
                                        ...
                                        fontSize: '16px',
                                        margin: '0 auto',
                                        backgroundImage: 'linear-gradient(to bottom, #ffffff 40%, #8888dd 100%)',
                                        backgroundSize: '100% 100%',
                                        WebkitTextFillColor: 'transparent',
                                        backgroundClip: 'text',
                                        WebkitBackgroundClip: 'text',
